...
public class Login extends JFrame {
	...
	public Login() {
		...
		separator.setBackground(new Color(210, 37, 22));
		separator.setBounds(65, 292, 324, 2);
		panel.add(separator);
		
		JLabel labelTitulo = new JLabel("INICIAR SESIÓN");
		labelTitulo.setForeground(new Color(172, 106, 105));
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(65, 149, 202, 26);
		panel.add(labelTitulo);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBackground(new Color(210, 37, 22));
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnLogin.setBackground(new Color(210, 37, 22));
			}
		
			@Override
			public void mouseExited(MouseEvent e) {
				btnLogin.setBackground(new Color(172, 106, 105));
			}
		});
		btnLogin.setBackground(new Color(172, 106, 105));
