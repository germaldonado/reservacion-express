...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		panelMenu.setBackground(new Color(172, 106, 105));
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btnRegistro.setBackground(new Color(210, 37, 22));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnRegistro.setBackground(new Color(172, 106, 105));
			}
			@Override
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBusqueda.setBackground(new Color(210, 37, 22));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnBusqueda.setBackground(new Color(172, 106, 105));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
	    ...
	    panelFecha.setBackground(new Color(210, 37, 22));
