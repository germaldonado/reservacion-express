...
public class RegistroHuesped extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped(reserva_id);
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int reserva_id) {
		...
		txtFechaN.getCalendarButton().setBackground(new Color(210, 37, 22));
		...
		txtNreserva.setText(String.valueOf(reserva_id));
		...
		separator_1_2_1.setForeground(new Color(172, 106, 105));
		separator_1_2_1.setBackground(new Color(172, 106, 105));
		contentPane.add(separator_1_2_1);

		JSeparator separator_1_2_2 = new JSeparator();
		separator_1_2_2.setBounds(560, 314, 289, 2);
		separator_1_2_2.setForeground(new Color(172, 106, 105));
		separator_1_2_2.setBackground(new Color(172, 106, 105));
		contentPane.add(separator_1_2_2);

		JSeparator separator_1_2_3 = new JSeparator();
		separator_1_2_3.setBounds(560, 386, 289, 2);
		separator_1_2_3.setForeground(new Color(172, 106, 105));
		separator_1_2_3.setBackground(new Color(172, 106, 105));
		contentPane.add(separator_1_2_3);

		JSeparator separator_1_2_4 = new JSeparator();
		separator_1_2_4.setBounds(560, 457, 289, 2);
		separator_1_2_4.setForeground(new Color(172, 106, 105));
		separator_1_2_4.setBackground(new Color(172, 106, 105));
		contentPane.add(separator_1_2_4);

		JSeparator separator_1_2_5 = new JSeparator();
		separator_1_2_5.setBounds(560, 529, 289, 2);
		separator_1_2_5.setForeground(new Color(172, 106, 105));
		separator_1_2_5.setBackground(new Color(172, 106, 105));
		...
		btnguardar.setBackground(new Color(172, 106, 105));
		...
		panel.setBackground(new Color(172, 106, 105));
	...
	private void guardarHuespedes(){
		if(txtFechaN.getDate() != null && !txtNombre.equals("")
				&& !txtApellido.equals("") && !txtTelefono.equals("")){

			String fecha_nacimiento = ((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText();

			int nreserva = Integer.parseInt(txtNreserva.getText());

			var huesped = new Huespedes(txtNombre.getText(), txtApellido.getText(), Date.valueOf(fecha_nacimiento),
